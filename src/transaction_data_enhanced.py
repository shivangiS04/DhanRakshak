...
class EnhancedFeatureExtractor:
    ...
    def _init_account_stats(self):
        return {
            ...
            "last_timestamp": None,
            "time_diffs": [],  # Store time differences instead of all timestamps
        }
    ...
    def process_transactions(self):
        logger.info("=" * 80)
        logger.info("STREAMING TRANSACTIONS WITH VELOCITY FEATURES")
        logger.info("=" * 80)
        ...
        for i, part in enumerate(parts):
            ...
            for account_id, group in df.groupby("account_id"):
                ...
                # Calculate time differences for velocity (memory efficient)
    ...
    def build_features(self):
        logger.info("=" * 80)
        logger.info("BUILDING ENHANCED FEATURES WITH VELOCITY")
        logger.info("=" * 80)
        ...
        for idx, (account_id, stats) in enumerate(self.account_stats.items()):
            ...
            # VELOCITY FEATURES: median time between transactions
...
def main():
    ...
    output_path = os.path.join(OUTPUT_DIR, "mega_transaction_features_enhanced.csv")
